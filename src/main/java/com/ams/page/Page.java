...
public class Page  implements java.io.Serializable {
	...
	public void setPagedView() {
		...
		if (hasPreviousPage) {
			...
			sb.append("<input type='button' value='首页' class='btn'  onclick='search_pagedForm(1);return false;'>");
			sb.append("&nbsp;&nbsp;");
			sb.append("<input type='button' value='上一页' class='btn'  onclick='search_pagedForm("
							+ (currentPage - 1)
							+ ");return false;'>");
			...
			sb.append("<input type='button' value='首页' class='btn'  onclick='search_pagedForm(1);return false;' disabled='disabled'>");
			sb.append("&nbsp;&nbsp;");
			sb.append("<input type='button' value='上一页' class='btn'  onclick='search_pagedForm("
		...
		sb.append("&nbsp;&nbsp;");
		if (hasNextPage) {
			sb.append("<input type='button' value='下一页' class='btn'  onclick='search_pagedForm("
					+ (currentPage + 1) + ");return false;'>");
			//sb.append("<a href='#' onclick='search_pagedForm("
			//				+ (currentPage + 1)
			//				+ ");return false;'><IMG title='下一页' src='../../images/2.gif' border=0></a>");
			sb.append("&nbsp;&nbsp;");
			sb.append("<input type='button' value='末页' class='btn'  onclick='search_pagedForm(" 
		...
		sb.append("<INPUT name=totalRows type=hidden value='" + totalRows
				+ "'>");		
		sb.append("&nbsp;&nbsp;");
		sb.append("<INPUT onclick='submit_pagedForm()' type=button value='跳到' class='btn btn-primary'>");
		sb.append("&nbsp;&nbsp;");
		sb.append("</TD>");
		sb.append("</TR>");
		sb.append("</TBODY>");
